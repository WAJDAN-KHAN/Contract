...
const Footer1 = () => {
  ...
  const links2 = [{ text: 'FAQ' }, { text: 'Careers' }];
  const links3 = [
        ...
        <div className="py-8 lg:py-10">
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1">
            ...
            <div className="grid md:grid-cols-3 grid-cols-1 md:gap-3 gap-1 md:col-span-5 col-span-3 sm:mr-8 mr-0 ">
                ...
                <ul className="list-none space-y-2 text-sm mb-0">
                  {links.map((link, index) => (
                    <li key={index} className="relative mb-[.75rem]">
                      <a href="" className="text-[#FFFFFF] text-[15px] font-light hover:text-[#066a9c]">
                        {link.text}
                      </a>
                    </li>
                  ))}
              ...
              <div className=" mb-5 md:mb-0">
                <h4 class="text-[24px] text-[#FFFFFF] font-semibold mb-3">Resources</h4>
                <ul className="list-none space-y-2 text-sm mb-0">
              ...
              <div className="  mb-5 md:mb-0">
                <h4 class="text-[24px] text-[#FFFFFF] font-semibold mb-3">Legal</h4>
                <ul className="list-none space-y-2 text-sm mb-0">
            ...
            <div className=" flex flex-col col-span-2 gap-2.5 mb-10 md:mb-0">
              <h1 className="text-white text-[24px] font-semibold">FOLLOW US ON</h1>
              {/* social media links */}
              <div className="flex gap-3">
                <a href="#" className="w-[30px] h-[30px] flex items-center justify-center rounded-[50%] bg-[white]">
                  <img src="/assets/facebook.svg" className="max-w-[15px] w-full h-auto object-contain" alt="" />
                </a>
                <a href="#" className="w-[30px] h-[30px] flex items-center justify-center rounded-[50%] bg-[#292929]">
                  <img src="/assets/instagram.png" className="max-w-[15px] w-full h-auto object-contain" alt="" />
                </a>
                <a href="#" className="w-[30px] h-[30px] flex items-center justify-center rounded-[50%] bg-[#292929]">
                  <img src="/assets/Frame1.svg" className="max-w-[15px] w-full h-auto object-contain" alt="" />
                </a>
                <a href="#" className="w-[30px] h-[30px] flex items-center justify-center rounded-[50%] bg-[#292929]">
                  <img src="/assets/Frame2.svg" className="max-w-[15px] w-full h-auto object-contain" alt="" />
                </a>
              </div>
              {/* social media links */}
            </div>
