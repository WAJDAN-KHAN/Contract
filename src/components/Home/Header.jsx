        ...
        <div className="md:flex hidden justify-between items-center py-4 2xl:container md:px-[20px] mx-auto px-[15px]">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <p className="text-[14px] text-[#757575] font-normal">Algo Price : </p>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-[#3a3131] rounded-[18px]">
              <div className="p-2 bg-[#FF0F0F] rounded-[18px]">
                <img src={moon} alt="" className="h-[16px]  w-[16px]  text-white flex-shrink-0" />
              </div>
              <div className="p-2">
                <img className="h-[16px] w-[16px] flex-shrink-0" src={brightness} alt="" />
              </div>
            </div>
       ...
       justify-between items-center sm:gap-5 gap-3 py-5 flex-wrap"
        >
          ...
          <div className="md:flex hidden gap-3 items-center">
            <a href="#" className="text-[white] text-[14px] font-normal">
              Home
            </a>
            <Dropdown
              label="Blockchain"
          ...
          <div className="md:hidden flex gap-4">
            ...
            <div className="hamburger" onClick={toggleDrawer}>
              <img className="w-[28px] h-[28px] cursor-pointer flex-shrink-0 " src={menu} alt="" />
            </div>
          </div>
